...
const getAllOptions = async (req, res) => {
    try {
        const options = await prisma.rbu_opcion_dignidad.findMany();
...
const getOptionById = async (req, res) => {
    const { id } = req.params;
    try {
        const option = await prisma.rbu_opcion_dignidad.findUnique({
...
const createOption = async (req, res) => {
    try {
        ...
        const lastOption = await prisma.rbu_opcion_dignidad.findFirst({
            orderBy: {
              id: 'desc',
            },
          });
        ...
        const newOption = await prisma.rbu_opcion_dignidad.create({
            data: req.body,
        });
...
const updateOption = async (req, res) => {
    ...
    try {
        ...
        const updatedOption = await prisma.rbu_opcion_dignidad.update({
            where: { id: parseInt(id) },
            data: req.body,
        });
...
const deleteOption = async (req, res) => {
    const { id } = req.params;
    try {
        await prisma.rbu_opcion_dignidad.delete({
            where: { id: parseInt(id) },
        });
        res.status(204).send();
    } catch (error) {
